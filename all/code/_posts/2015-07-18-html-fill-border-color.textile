...
<p></p>
<h2 class="bottomLine lightBlue">{{ page.title }}</h2>
...
<p>i.e. calculate rotation needed : 30%-25% = 5% of 360deg equals 
18deg to increase rotation of one border to add those 5.%</p>
</pre>
